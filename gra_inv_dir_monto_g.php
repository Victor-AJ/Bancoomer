<?
	...
	$FC = new FusionCharts($grafica,"940","350"); 
	# set the relative path of the swf file
	$FC->setSWFPath("FusionCharts/Charts/");	
	# Store chart attributes in a variable 
	$strParam="caption=;subcaption=;xAxisName=Direcciones;yAxisName=Monto Mensual;numberPrefix=$;decimalPrecision=0";
	...
	$valBita.="tx_moneda=$tx_moneda ";
	 ...
	 $myBitacora->anotaBitacora ($mysql, "GRAFICA" , "TBL_LICENCIA" , "$id_login" ,   $valBita  ,"" ,"gra_inv_dir_monto_g.php");
	 //<\BITACORA>
