...
<?
	...
	if ($par_moneda=="USD") $sql = "   SELECT c.id_departamento, e.tx_departamento, SUM(IF(a.id_moneda=1,IF(a.fl_tipo_cambio=0,(b.fl_precio_mxn/$in_tc),(b.fl_precio_mxn/a.fl_tipo_cambio)),(b.fl_precio_usd))) AS total_precio_usd ";
	else 					$sql = "   SELECT c.id_departamento, e.tx_departamento, SUM(IF(a.id_moneda=2,IF(a.fl_tipo_cambio=0,(b.fl_precio_usd*$in_tc),(b.fl_precio_usd*a.fl_tipo_cambio)),(b.fl_precio_mxn))) AS total_precio_usd ";
	$sql.= "     FROM tbl_factura a, tbl_factura_detalle b, tbl_centro_costos c, tbl_direccion d , tbl_departamento e, tbl_factura_estatus f , tbl_producto p  ";
	...
	$sql.= "      AND c.id_departamento 	= e.id_departamento  and e.tx_indicador='1' ";
	...
	$sql.= " GROUP BY e.id_departamento ";
	...
	echo "<br/>";
	echo "<div class='ui-widget-header align-center'>FACTURACION - $tx_direccion - $tx_subdireccion</div>";
	if ($registros==0) {	
		...
		echo "<table id='tbl_Det_Fac' align='center' width='100%' border='1' cellspacing='1' cellpadding='1'>";
		echo "<tr>";
		echo "<td width='3%' class='ui-state-highlight align-center'>#</td>";							 
		echo "<td width='10%' class='ui-state-highlight align-center'>DEPARTAMENTO</td>";	
		echo "<td width='7%' class='ui-state-highlight align-center'>PROVEEDOR</td>";				
		echo "<td width='6%' class='ui-state-highlight align-center'>ENERO</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>FEBRERO</td>";						 
		echo "<td width='6%' class='ui-state-highlight align-center'>MARZO</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>ABRIL</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>MAYO</td>";						 
		echo "<td width='6%' class='ui-state-highlight align-center'>JUNIO</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>JULIO</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>AGOSTO</td>";						 
		echo "<td width='6%' class='ui-state-highlight align-center'>SEPTIEMBRE</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>OCTUBRE</td>";	
		echo "<td width='6%' class='ui-state-highlight align-center'>NOVIEMBRE</td>";						 
		echo "<td width='6%' class='ui-state-highlight align-center'>DICIEMBRE</td>";	
		...
		{ 	        			 
			while ($elemento = each($TheInformeSubdireccionFac[$i]))				
				$id_departamento	=$TheInformeSubdireccionFac[$i]["id_departamento"];	  		
				$tx_departamento	=$TheInformeSubdireccionFac[$i]["tx_departamento"];						
				...
				for ($m=1; $m<13; $m++)
				{ 					
					if ($par_moneda=="USD") $sql1 = "   SELECT c.id_departamento, e.tx_departamento, SUM(IF(a.id_moneda=1,IF(a.fl_tipo_cambio=0,(b.fl_precio_mxn/$in_tc),(b.fl_precio_mxn/a.fl_tipo_cambio)),(b.fl_precio_usd))) AS total_precio_usd ";
					else 					$sql1 = "   SELECT c.id_departamento, e.tx_departamento, SUM(IF(a.id_moneda=2,IF(a.fl_tipo_cambio=0,(b.fl_precio_usd*$in_tc),(b.fl_precio_usd*a.fl_tipo_cambio)),(b.fl_precio_mxn))) AS total_precio_usd ";										
					$sql1.= "     FROM tbl_factura a, tbl_factura_detalle b, tbl_centro_costos c, tbl_direccion d ,tbl_departamento e, tbl_proveedor f, tbl_factura_estatus g , tbl_producto p ";
					...
					$sql1.= "      AND c.id_subdireccion 	= $par_subdireccion ";
					$sql1.= "      AND c.id_departamento 	= $id_departamento ";
					$sql1.= "      AND c.id_departamento 	= e.id_departamento  and e.tx_indicador='1'";					
					$sql1.= "      AND a.id_mes 			= $m ";
					...
					if ($par_cuenta <> 0)
						...
						$sql1.= " GROUP BY e.id_departamento ";
				...
				for ($m=1; $m<13; $m++)	{ 	
					...
					if ($par_estatus==0) 
						...
						$sql1.= " AND g.id_factura_estatus = $par_estatus ";
					...
					while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC))
					{	
						$TheInformeSubdireccionFac_2[] = array(						
					...
					for ($j=0; $j < count($TheInformeSubdireccionFac_2); $j++)
					{ 	        			 
						while ($elemento = each($TheInformeSubdireccionFac_2[$j]))	
							$total_precio_usd_r_0 =$TheInformeSubdireccionFac_2[$j]['total_precio_usd_r_0'];	
					}							
				...
				for ($m=1; $m<13; $m++)	{ 	
					...
					while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC))
					{	
						$TheInformeSubdireccionFac_3[] = array(						
					...
					for ($j=0; $j < count($TheInformeSubdireccionFac_3); $j++)	{ 	        			 
						while ($elemento = each($TheInformeSubdireccionFac_3[$j]))	
							$total_precio_usd_o_0 =$TheInformeSubdireccionFac_3[$j]["total_precio_usd_o_0"];	
					}							
				...
				for ($a=0; $a<16; $a++)
				{
					...
					{   
						...
						break;						
						case 1: $TheColumn =$tx_departamento;
								//$TheColumn = "<a href='#' style='cursor:pointer' onclick='javascript:btnInformesDirFac($id_subdireccion)' title='Presione para ver el detalle de $tx_subdireccion ...'>$tx_subdireccion</a>";
			...
			echo "<td class='ui-state-highlight align-center'>DEPARTAMENTO</td>";	
			echo "<td class='ui-state-highlight align-center'>PROVEEDOR</td>";				
			echo "<td class='ui-state-highlight align-center'>ENERO</td>";	
			echo "<td class='ui-state-highlight align-center'>FEBRERO</td>";						 
			echo "<td class='ui-state-highlight align-center'>MARZO</td>";	
			echo "<td class='ui-state-highlight align-center'>ABRIL</td>";	
			echo "<td class='ui-state-highlight align-center'>MAYO</td>";						 
			echo "<td class='ui-state-highlight align-center'>JUNIO</td>";	
			echo "<td class='ui-state-highlight align-center'>JULIO</td>";	
			echo "<td class='ui-state-highlight align-center'>AGOSTO</td>";						 
			echo "<td class='ui-state-highlight align-center'>SEPTIEMBRE</td>";	
			echo "<td class='ui-state-highlight align-center'>OCTUBRE</td>";	
			echo "<td class='ui-state-highlight align-center'>NOVIEMBRE</td>";						 
			echo "<td class='ui-state-highlight align-center'>DICIEMBRE</td>";	
	 ...
	 $myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL_FACTURA TBL_FACTURA_DETALLE" , "$id_login" ,   $valBita ,"" ,"inf_facturacion_dir_sub_dep.php");
	 //<\BITACORA>
