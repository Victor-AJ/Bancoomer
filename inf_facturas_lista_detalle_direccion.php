...
<?
	...
	$sql.= "      AND c.id_subdireccion 	= $par_subdireccion  and a.tx_indicador='1' ";
	...
	//<BITACORA>
	 ...
	 $myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL_FACTURA_DETALLE" , "$id_login" ,   $valBita ,"" ,"inf_facturas_lista_detalle_direccion.php");
	 //<\BITACORA>
