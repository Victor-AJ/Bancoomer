...
<?
	...
	$sql.= " 	 AND a.id_telefonia_plan = d.id_telefonia_plan and a.tx_indicador='1'  ";
	...
	if ($registros==0) { }
		...
		for ($a=0; $a<10; $a++)
		{
			...
			{   
				...
				break;
				case 9 : $TheField=""; 
					echo "<td colspan='2' class='ui-state-highlight align-center'>&nbsp;</td>";					
				break;
			}							
		}	
		echo "</tr>";	
	 ...
	 $myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL_EMPLEADO_TELEFONIA" , "$id_login" ,   "id_empleado=$id" ,"" ,"cat_telefonia_lista_read.php");
	 //<\BITACORA>
