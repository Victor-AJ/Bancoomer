    ...
    function addButtonEvents(){
		...
		$("#btnNew").click(function(){
        	...
        	if(!editing){					
				...
				loadHtmlAjax(true, $("#divAlta"), "cat_carta_aceptacion_m.php?dispatch="+dispatch);
        	}
		});
		...
		$("#btnEdit").click(function(){		
            ...
            if(!editing){
                ...
                if(gr != null){
                    ...
                    lastsel = gr;
					jQuery("#list1").setGridState("hidden");
					loadHtmlAjax(true, $("#divAlta"), "cat_carta_aceptacion_m.php?dispatch="+dispatch+"&id="+gr);
                }else {
			...
			if(fieldsReq()){	
			 	if(editing){
					...
					if (adding) var dispatch ="insert";
				 	...
				 	var url = "process_carta_aceptacion.php?dispatch="+dispatch+"&id="+id+"&";
        ...
        $("#btnDelete").click(function(){
            if(!editing){        
                ...
                var fAceptar = function(){
					...
					var url = "process_carta_aceptacion.php?dispatch=delete&id="+gr;
					//alert (url);
					executeAjax("post", false ,url, "json", func);
    ...
    <form id="catalogForm" method="" action="">
        ...
        <div id="divGrid" style="padding:1%;width:98%" class="ui-widget ui-widget-content ui-corner-all">
            ...
            <script type="text/javascript">
				(function($){
					jQuery("#list1").jqGrid({
                        caption:"Cat&aacute;logo Carta de Aceptaci&oacute;n",
                        mtype: "GET",                       
						url:'process_carta_aceptacion.php?dispatch=load',
                        datatype: "json",
                        colNames:['Edo.','ID','Empresa','Nombre GLG','Codigo GLG','L&iacute;nea de Gasto','Codigo Cuenta','Familia','Orden de Compra','Requisici&oacute;n','N&uacute;mero de Partida','Pa&iacute;s del Servicio','Indicador','Fecha modifica','Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
                            {name: 'edo', index: 'edo', width: 30, align:"center", sortable: false, formoptions:{label: "Estado", rowpos:1 } },
                            {name:'id',index:'id_carta_aceptacion', width:35, align:"center", editable:false, editoptions:{readonly:true,size:10}, 
								formoptions:{label: "Id", rowpos:2 }                               
                            },
                            {name:'tx_empresa',index:'tx_empresa',width:200, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Empresa / Sociedad receptora del servicio", rowpos:3 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },							
                            {name:'tx_nombre_glg',index:'tx_nombre_glg',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Nombre de la GLG", rowpos:4 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },							
                            {name:'tx_codigo_glg',index:'tx_codigo_glg',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Codigo GLG", rowpos:5 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },							
                            {name:'tx_linea_gasto',index:'tx_linea_gasto',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "L&iacute;nea del Gasto asignada", rowpos:6 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },		
							{name:'tx_codigo_cuenta',index:'tx_codigo_cuenta',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Codigo Cuenta", rowpos:7 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },						
							{name:'tx_familia',index:'tx_familia',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Familia", rowpos:8 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },
							{name:'tx_orden_compra',index:'tx_orden_compra',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Orden de compra n&uacute;mero", rowpos:9 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },		
							{name:'tx_requision_numero',index:'tx_requision_numero',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Requisici&oacute;n n&uacute;mero", rowpos:10 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },		
							{name:'tx_numero_partida',index:'tx_numero_partida',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "N&uacute;mero Partida / Proyecto", rowpos:11 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },			
							{name:'tx_pais',index:'tx_pais',width:300, align:"left", editable:false, 
                                editoptions:{size:255,maxlength: 255},
                                editrules:{required:true},
                                formoptions:{label: "Pa&iacute;s", rowpos:12 },
								searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc']}
                            },			
							{name:'tx_indicador',index:'tx_indicador',width:80, align:"center", editable:false,
                                ...
                                editrules:{required:true},
                                formoptions:{label: "Indicador", rowpos:13 },
                        ...
                        //height:360,
						height:$("#CenterPane").height()-$("#NorthPane").height()-150,
						shrinkToFit :false,
            			sortable: true,
                        ...
                        sortname: 'id_carta_aceptacion',  // primer columna de ordenacion
