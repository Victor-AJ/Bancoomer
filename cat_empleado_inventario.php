...
<?
	...
	//<BITACORA>
	 ...
	 $myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL_EMPLEADO" , "$id_login" ,   $cadBita ,"" ,"cat_empleado_inventario.php");
	 //<\BITACORA>
	...
	$sql = "   SELECT C.id_centro_costos, tx_centro_costos ";
	$sql.= "     FROM tbl_centro_costos C ";
        ...
        <table cellspacing="1px" border="0" cellpadding="0" width="100%">         
            ...
            <tr>
              <td colspan="6">
                    ...
                    <div id="divMasDatos"  class="ui-helper-hidden">
                  		<table cellspacing="1px" border="0" cellpadding="0" width="100%">
		                  	<tr>
