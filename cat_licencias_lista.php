...
?>
	 <script type="text/javascript">
		...
		$("#btnNewLic").click(function(){
			...
			var url="cat_licencias_m.php?"+id+dispatch;   
			
			//alert ("Entre"+url); 
        	//if(!editing){					
				
				loadHtmlAjax(true, $("#divAltaLic"), url);
        	//}
		 }).hover(function(){
...
<?
	...
	//CAMBIO CUENTAS CONTABLES, SE CAMBIA QUERY PARA TRAER CUENTA CONTABLE DE CAT GLOBAL
	//$sql = "  SELECT id_licencia, tx_proveedor_corto, tx_producto, tx_cuenta, c.tx_descripcion, in_licencia, a.fl_precio_usd, a.fl_precio_mxn, tx_concepto_contable, tx_login, tx_sid_terminal, tx_serial_number, a.tx_indicador ";
...
//echo "sql",$sql;	
	...
	$myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL_LICENCIA" , "$id_login" ,  "id_empleado=$id" , ""  ,  "cat_licencias_lista.php");
	//<\BITACORA>
    ...
    <div>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
    		<tr id="Act_Buttons">
    			...
    			<a id="btnNewLic" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" href="javascript:void(0)" style="font-size:smaller;" title="Agregar Licencias"> 
    			Agregar
				...
				for ($a=0; $a<14; $a++)
					{
						...
						{   
							...
							break;
							case 12 : $TheColumn ="<a href='#' style='cursor:pointer' onclick='javascript:btnEditLicencia($id, $id_licencia)';><span class='ui-icon ui-icon-pencil' title='Presione para editar ...'></span></a>";				
								echo "<td class='ui-widget-header align-center' valign='top'>$TheColumn</td>";
							break;													
							case 13 : $TheColumn = "<a href='#' style='cursor:pointer' onclick='javascript:btnDeleteLicencia($id, $id_licencia)';><span class='ui-icon ui-icon-trash' title='Presione para ELIMINAR ...'></span></a>";
								echo "<td class='ui-widget-header align-center' valign='top'>$TheColumn</td>";
							break;			
						}							
					}				
