			...
			if(fieldsReq()){	
			 	if(editing){
					...
					if (adding) var dispatch ="insert";
				 	...
				 	var url = "process_opciones.php?dispatch="+dispatch+"&id="+id+"&";
        ...
        $("#btnDelete").click(function(){
            if(!editing){        
                ...
                var fAceptar = function(){
					...
					var url = "process_opciones.php?dispatch=delete&id="+gr;
					//alert (url);
					executeAjax("post", false ,url, "json", func);
            ...
            <script type="text/javascript">
                jQuery(document).ready(function(){
                    var mygrid = jQuery("#list1").jqGrid({
                        caption:"Catálogo de Opciones del Menú",
                        mtype: "GET",                       
						url:'process_opciones.php?dispatch=load',
						//alert ("Envio"+url);
                        editurl:'process_opciones.php?dispatch=delete&id',
                        datatype: "json",
                        ...
                        colModel:[   
                            ...
                            {name:'id',index:'id_opcion',width:30, align:"center", editable:false, editoptions:{readonly:true,size:10},
                        ...
                        sortname: 'id_opcion', // primer columna de ordenacion
