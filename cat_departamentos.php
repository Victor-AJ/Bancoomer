...
<script type="text/javascript">
    ...
    function addButtonEvents(){
        ...
        $("#btnNew").click(function(){
            if(!editing){
				var datarow = {id_departamento:"0",tx_subdireccion:"",tx_departamento:"",tx_indicador:"ACTIVO",fh_ultimoacceso:"",fh_mod:"",id_usuariomod:"",fh_alta:"",id_usuarioalta:""};
			...
			if(fieldsReq()){	
			 	if(editing){
					...
					if (adding) var dispatch ="insert";
				 	...
				 	var url = "process_departamentos.php?dispatch="+dispatch+"&id="+id+"&";
        ...
        $("#btnDelete").click(function(){
            if(!editing){        
                ...
                var fAceptar = function(){
					...
					var url = "process_departamentos.php?dispatch=delete&id="+gr;
					//alert (url);
					executeAjax("post", false ,url, "json", func);
            ...
            <script type="text/javascript">
                jQuery(document).ready(function(){
                    var mygrid = jQuery("#list1").jqGrid({
                        caption:"Catálogo de Departamentos (CR Departamento)",
                        mtype: "GET",                       
						url:'process_departamentos.php?dispatch=load',
						//alert ("Envio"+url);
                        editurl:'process_departamentos.php?dispatch=delete&id',
                        datatype: "json",
                        colNames:['Edo.','Id','SubDirecci&oacute;n','Departamento','Indicador','Fecha modifica', 'Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
                            {name: 'edo', index: 'edo', width:30, align:"center", sortable: false },
                            {name:'id',index:'id_departamento',width:30, align:"center", editable:false,
                                editoptions:{readonly:true,size:10}                                
                            },
							{name:'tx_subdireccion',index:'tx_subdireccion',width:350, align:"left", editable:true, 
								formoptions:{rowpos:1},
							 	edittype:'select',								
								editoptions:{dataUrl:'cat_carga.php?dispatch=subdireccion', defaultValue:'id_subdireccion'},								
                        ...
                        sortname: 'tx_subdireccion, tx_departamento ', // primer columna de ordenacion
					...
					{height:400,width:700,jqModal:false,closeOnEscape:true} // view options
                ).navButtonAdd('#pager1',{
                        id:"btnPin",
                        caption:"Mostrar",
