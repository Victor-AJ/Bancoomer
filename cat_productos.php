    ...
    function addButtonEvents()
    {
		...
		$("#btnNew").click(function()
        						...
        						if(!editing){					
											...
											loadHtmlAjax(true, $("#divAlta"), "cat_productos_m.php?dispatch="+dispatch);
        									}
								}
							);
								...
								{	
						 		if(editing)
									...
									if (adding) 
							 		...
							 		var url = "process_productos.php?dispatch="+dispatch+"&id="+id+"&";
            					...
            					if(!editing)
                					...
                					var fAceptar = function()
										...
										var func = function(data)
											...
											var url = "process_productos.php?dispatch=delete&id="+gr;
											//alert (url);
											executeAjax("post", false ,url, "json", func);
							               };
							               ...
							               var fCancelar = function()
                							...
                							if( gr != null )
                    							{
                    							jConfirm(true,"\u00bfDesea inactivar el registro  seleccionado", fAceptar, fCancelar);
                								}
            								else
                								{
...
<div>
    <form id="catalogForm"  action="">
        ...
        <div id="divGrid" style="padding:1%;width:98%" class="ui-widget ui-widget-content ui-corner-all">
            ...
            <div id="divAlta"></div> 
            <script type="text/javascript">
            //1.- CUENTASCONT: se agrega colName CuentaContable
            //2.- CUENTASCONT: se agrega colModel de CuentaContable 
			(function($)
				{
				jQuery("#list1").jqGrid
						(
						{
                        caption:"Cat&aacute;logo de Productos",
                        mtype: "GET",                       
						url:'process_productos.php?dispatch=load',
                        datatype: "json",
                        colNames:['Edo.','ID','Proveedor','Producto','Cuenta Contable','Nombre Corto','Descripci&oacute;n','Descripci&oacute;n Corta','Precio USD','Precio MXN','Precio EUR','Licencia','Indicador','Fecha modifica', 'Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
                            		{name: 'edo', index: 'edo', width: 30, align:"center", sortable: false, search: false , formoptions:{label: "Estado", rowpos:1 } },
                            		{name:'id',index:'id_producto',width:30, align:"center", editable:false, editoptions:{readonly:true,size:10}, formoptions:{label: "Id", rowpos:2 } , searchoptions:{sopt:['eq','ne','lt','gt'] }    },
                            		{name:'tx_proveedor',index:'tx_proveedor',width:300, align:"left", editable:false, formoptions:{label: "Proveedor", rowpos:3 } , searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc'] }  },  

                                    {name:'tx_producto',index:'tx_producto',width:300, align:"left", editable:false, 
                                		editoptions:{size:255,maxlength: 255},
                                		editrules:{required:true},
                                		formoptions:{label: "Producto", rowpos:4 },
										searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']}
                            		},
		                            {name:'tx_cuenta_contable',index:'tx_valor',width:200, align:"left", editable:false, 
        		                    editoptions:{size:255,maxlength: 255},
                			        editrules:{required:true},
                                	formoptions:{label: "Cuenta Contable", rowpos:8 },
									searchoptions:{sopt:['eq','ne','in','ni','cn','nc']}
                            		},
									{name:'tx_producto_corto',index:'tx_producto_corto',width:200, align:"left", editable:false, 
		                                editoptions:{size:255,maxlength: 255},
		                                editrules:{required:true},
		                                formoptions:{label: "Nombre Corto", rowpos:5 },
										searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']}
		                            },
									{name:'tx_descripcion',index:'b.tx_descripcion',width:400, align:"left", editable:false, 
		                                editoptions:{size:255,maxlength: 255},
		                                editrules:{required:true},
		                                formoptions:{label: "Descripci&oacute;n", rowpos:6 },
										searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']}
		                            },
									{name:'tx_descripcion_corta',index:'tx_descripcion_corta',width:200, align:"left", editable:false, 
		                                editoptions:{size:255,maxlength: 255},
		                                editrules:{required:true},
		                                formoptions:{label: "Descripci&oacute;n Corta", rowpos:7 },
										searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']}
		                            },
									...
									{name:'fl_precio',index:'fl_precio',width:100, align:"right", editable:false, 
		                                editoptions:{size:255,maxlength: 255},
		                                editrules:{required:true},
		                                formoptions:{label: "Precio USD", rowpos:9 },
										searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc','lt','le','gt','ge']}
		                            },
									{name:'fl_precio_mxn',index:'fl_precio_mxn',width:100, align:"right", editable:false, 
		                                editoptions:{size:255,maxlength: 255},
		                                editrules:{required:true},
		                                formoptions:{label: "Precio MXN", rowpos:10 },
										searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc','lt','le','gt','ge']}
		                            },
		                            {name:'fl_precio_eur',index:'fl_precio_eur',width:100, align:"right", editable:false, 
		                                editoptions:{size:255,maxlength: 255},
		                                editrules:{required:true},
		                                formoptions:{label: "Precio EUR", rowpos:10 },
										searchoptions:{sopt:['eq','ne','in','ni','bw','bn','ew','en','cn','nc','lt','le','gt','ge']}
		                            },
									{name:'in_licencia',index:'in_licencia',width:60, align:"center", editable:false, 
		                                editrules:{required:true},
		                                formoptions:{label: "Licencia", rowpos:11 },
										searchoptions:{sopt:['eq','ne','in','ni']}
		                            },
									{name:'tx_indicador',index:'b.tx_indicador',width:80, align:"center", editable:false,
		                            	edittype:"select",
		                            	search:true,
										stype:"select",
										searchtype: "number" ,
		                                editrules:{required:true},
		                                formoptions:{label: "Indicador", rowpos:12 },
		                                searchoptions:	{ 
		                            ...
		                            {name:'fh_mod',index:'b.fh_mod',width:110, align:"center", editable:false,
		                            ...
		                            {name:'id_usuariomod',index:'d.tx_nombre',width:150, align:"left", editable:false,
		                                editoptions:{readonly:true, size:60},
		                                searchoptions:{sopt:['eq','ne','cn','nc']}
		                            },
		                            {name:'fh_alta',index:'b.fh_alta',width:110, align:"center", editable:false,
		                                editoptions:{readonly:true,size:60},
		                                searchoptions:	{dataInit:function(el2)
			                                							{
		                            ...
		                            {name:'id_usuarioalta',index:'e.tx_nombre',width:150, editable: false,
		                                editoptions:{readonly:true,size:10},
		                                searchoptions:{sopt:['eq','ne','cn','nc']}
		                            }
                        ],
                        ...
                        sortname: 'tx_proveedor, tx_producto',  // primer columna de ordenacion
				...
				jQuery("#list1").navButtonAdd('#pager1',{
								                        id:"btnPin",
								                        caption:"Mostrar",
