<script type="text/javascript">
    ...
    function addButtonEvents(){
        $("#btnNew").click(function(){
            if(!editing){
                var datarow = {id:"0",tx_nombre:"",tx_indicador:"ACTIVO",fecha_mod:"",idusuario_mod:"",fecha_alta:"",idusuario_alta:""};
		...
		function fieldsReq(){			
			...
			var va_opcion='#'+id+'_tx_nombre';			
			//alert($(va_usuario).val());	
			var error = true;
			validText(false, $(va_opcion), $("#divError"), 1);
			
			if ( !validSelect($(va_opcion), $("#divError"))) error=false;
			return error;
		}
...
<?
	$id_inicio = $_GET["id"];
?>	
	<input id="id_inicio" name="id_inicio" type="text" class="textbox" value="<? echo $id_inicio ?>" />
        ...
        <div id="divGrid" style="padding:1%;width:98%" class="ui-widget ui-widget-content ui-corner-all">
            ...
            <script type="text/javascript">
                jQuery(document).ready(function(){
					var id_inicio = <? echo $id_inicio ?>;
                    var mygrid = jQuery("#list1").jqGrid({
                        caption:"Opciones del Menú",
                        mtype: "GET",                       
						url:'process_perfil_opciones.php?dispatch=load&id_ini='+id_inicio,
						//alert ("Envio"+url);
                        editurl:'process_perfil_opciones.php?dispatch=delete&id',
                        datatype: "json",
                        colNames:['Edo.','Id','Opción','Indicador','Fecha modifica', 'Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
                            ...
                            {name:'tx_nombre',index:'a.tx_nombre',width:160, align:"left", editable:true, 
                        ...
                        //height:360,
						height:$("#CenterPane").height()-$("#NorthPane").height()-200,
						shrinkToFit :false,
            			sortable: true,
