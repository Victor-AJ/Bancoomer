<script type="text/javascript">
    ...
    function addButtonEvents(){
        $("#btnNew").click(function(){
            if(!editing){
                var datarow = {id:"0",perfil:"",opcion:"",tx_indicador:"ACTIVO",fecha_mod:"",idusuario_mod:"",fecha_alta:"",idusuario_alta:""};
		...
		function fieldsReq(){			
			...
			validSelect($(va_opcion), $("#divError")); 			
			
			
			if ( !validSelect($(va_perfil), $("#divError")) || !validSelect($(va_opcion), $("#divError"))) error=false;			
            ...
            <script type="text/javascript">
                jQuery(document).ready(function(){
                    var mygrid = jQuery("#list1").jqGrid({
                        ...
                        datatype: "json",
                        colNames:['Edo.','Id','Perfil','Opción del Menú','Indicador','Fecha modifica', 'Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
                            {name: 'edo', index: 'edo', width: 20, align:"center", sortable: false },
                            {name:'id',index:'id_perfil',width:20, align:"center", editable:false,
                            ...
                            {name:'opcion',index:'c.tx_nombre',width:250, align:"left", editable:true, 
								formoptions:{label: "Opción del Menú", rowpos:2},
								edittype:'select',
							...
							{name:'tx_indicador',index:'a.tx_indicador',width:80, align:"center", editable:true,
								formoptions:{label: "Indicadoe", rowpos:3},
                                edittype:"select",
