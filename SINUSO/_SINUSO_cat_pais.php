...
<script type="text/javascript">
    ...
    function addButtonEvents(){
        $("#btnNew").click(function(){
            if(!editing){
                var datarow = {id:"0",tx_pais:"",tx_indicador:"ACTIVO",fecha_mod:"",idusuario_mod:"",fecha_alta:"",idusuario_alta:""};
		...
		function fieldsReq(){			
			...
			var error = true;
			validText(false, $(va_pais), $("#divError"), 1);
			
			if ( !validSelect($(va_pais), $("#divError"))) error=false;
			return error;
		}		
			...
			if(fieldsReq()){	
			 	if(editing){
					...
					if (adding) var dispatch ="insert";
				 	...
				 	var url = "process_paises.php?dispatch="+dispatch+"&id="+id+"&";
        ...
        $("#btnDelete").click(function(){
            if(!editing){        
                ...
                var fAceptar = function(){
					...
					var url = "process_paises.php?dispatch=delete&id="+gr;
					//alert (url);
					executeAjax("post", false ,url, "json", func);
            ...
            <script type="text/javascript">
				...
				(function($){
                    ...
                    //var mygrid = jQuery("#list1").jqGrid({
                        caption:"Catálogo de Pa&iacute;ses",
                        mtype: "GET",                       
						url:'process_paises.php?dispatch=load',
						//alert ("Envio"+url);
                        //editurl:'process_paises.php?dispatch=delete&id',
                        datatype: "json",
                        colNames:['Edo.','ID','Pa&iacute;s','Indicador','Fecha modifica', 'Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
                            {name: 'edo', index: 'edo', width: 20, align:"center", sortable: false, formoptions:{label: "Estado", rowpos:1 } },
                            {name:'id',index:'id_pais',width:20, align:"center", editable:false, editoptions:{readonly:true,size:10}, 
							...
							{name:'tx_indicador',index:'tx_indicador',width:80, align:"center", editable:true,
                                ...
                                editrules:{required:true},
                                formoptions:{label: "Indicador", rowpos:4 },
                        ...
                        sortname: 'tx_pais', // primer columna de ordenacion
					...
					{height:300,width:500,jqModal:false,closeOnEscape:true} // view options
                ).navButtonAdd('#pager1',{
                        id:"btnPin",
                        caption:"Mostrar",
