...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var urlfiles2 = 'fileProcess.do?dispatch=upload=sophie='+${beanOp.idopportunity}+'='+$("#userid").val();
        ...
        $("#selpromotor").change(function () {
            if(validSelect($(this), $("#errpromotor"))){
                fieldsRequired();
        ...
        jQuery("#filelist2").jqGrid({
            ...
            pager: '#pagerfiles2', // Nombre del paginador
            ...
            width: $("#gview_list2").width(),    // Ancho automatico para columnas
            height:100,
            shrinkToFit :false,
            sortable: true,
        ...
        {} // view options
            ...
            onClickButton:function(){
                jQuery("#filelist2").searchGrid({closeOnEscape:true,multipleSearch:true});
            }
        }).navButtonAdd('#pagerfiles2',{
            id:"btnDownload",
            caption:"Descargar",
...
<div class="ui-widget ui-widget-content ui-helper-clearfix" style="font-size:11px;width:100%;">
    ...
    <div class="ui-jqdialog-content ui-widget-content">
        <form id="opForm2" action="">
            <table cellspacing="2px" border="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <input id="id" name="id" type="text" value="<c:if test="${beanOp.idopportunity != null}"><jsp:getProperty name="beanOp" property="idopportunity"/></c:if>"
                                   ...
                                   title="Identificador de la oportunidad" class="ui-state-default" disabled="disabled"/>
                        </td>
                        <td width="10%"><div id="errid" style="float:left;"></div></td>
                        <td width="10%" class="ui-state-default"><label for="selestado">Estado:</label></td>
                        <td width="20%">
                          <select id="selestado" name="selestado" onchange="fieldsRequired();">
                                <option value="1" selected>PRE-PIPELINE</option>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                          <input id="fcierre" name="fcierre" type="text" value="<fmt:formatDate value="${beanOp.date_estimated_close}" pattern="MM/yyyy" />" size="10" maxlength="10"
                                   title="Fecha estimada de cierre de operaci&oacute;n" readonly/>
                        </td>
                        ...
                        <td width="20%">
                          <select id="selpromotor" name="selpromotor">
                            ...
                            <c:forEach var="beanPromotor" items="${listapromotores}">
                              ...
                              <option title="${beanPromotor.username}"
                ...
                if (beanOp.getIdpromoter().equals(beanPromotor.getIdpromoter())) {%>selected<%}
                                        ...
                                        <jsp:getProperty name="beanPromotor" property="username"/>
                              </option>
                            </c:forEach>
                          </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <input id="idproducto" name="idproducto" type="hidden" value="<jsp:getProperty name="beanOp" property="product"/>"/>
                            <input id="producto" name="producto" type="text" value="<jsp:getProperty name="beanOp" property="product_desc"/>" size="30" maxlength="30"
                                   title="Producto asociado a la oportunidad"/>
                        </td>
                                ...
                                <tr>
                                    ...
                                    <td width="5%">
                                        <input id="probabilidad" name="probabilidad" type="text" size="1" style="text-align:center;" maxlength="3"
                                               ...
                                               title="Porcentaje de probabilidad de cierre" class="ui-state-default" disabled="disabled"/>
                                    </td>
                                    <td>%</td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            ...
                            <input id="gpoprod" name="gpoprod" type="text" value="<jsp:getProperty name="beanOp" property="prod_grp_desc"/>" size="30" maxlength="30"
                                   title="Grupo de productos" class="ui-state-default" disabled="disabled"/>
                        </td>
                ...
                if (beanOp.getIdtrack().equals(beanTrack.getIdtrack())) {%>selected<%}
                                        ...
                                        <jsp:getProperty name="beanTrack" property="name"/>
                              </option>
                            </c:forEach>
                          </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                          <textarea id="descrip" name="descrip" cols="45" rows="5" title="Descripci&oacute;n de la operaci&oacute;n"><jsp:getProperty name="beanOp" property="description"/></textarea>
                        </td>
                        ...
                        <td width="20%">
                          <textarea id="comentario" name="comentario" cols="45" rows="5" title="Comentario del seguimiento del clientes"><jsp:getProperty name="beanOp" property="comment_monitoring"/></textarea>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <table>
                                <tr>
                                    <td>
                                        <input id="plazo" name="plazo" type="text" style="text-align:right" value="<jsp:getProperty name="beanOp" property="term"/>" size="6" maxlength="10"
                                               title="Plazo"/>
                                    </td>
                                    <td  class="ui-state-default">
                                        ...
                                        <input id="tipoplazo" name="tipoplazo" type="radio" value="y" checked>A&ntilde;os
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%"><select id="selmoneda" name="selmoneda">
                          ...
                          <c:forEach var="beanCurrency" items="${listamonedas}">
                            ...
                            <option title="${beanCurrency.name}"
                ...
                if (beanOp.getIdcurrency().equals(beanCurrency.getIdcurrency())) {%>selected<%}
                            ...
                            <jsp:getProperty name="beanCurrency" property="code"/>                        
                              &nbsp;-&nbsp;
                              <jsp:getProperty name="beanCurrency" property="name"/>                        
                            </option>
                          </c:forEach>
                        </select></td>
                        ...
                        <td width="20%">
                            ...
                            <input id="grupo" name="grupo" type="text" value="<jsp:getProperty name="beanOp" property="group_desc"/>" size="50" maxlength="100"
                                   title="Grupo empresarial al que pertence la contraparte" class="ui-state-default" disabled="disabled"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <input id="monto" style="text-align:right" name="monto" type="text" value="<fmt:formatNumber type="currency" value="${beanOp.amount}" currencySymbol=""/>" size="30" maxlength="30"
                                   alt="decimal-us" title="Monto de la operaci&oacute;n"/>
                        </td>
                        ...
                        <td width="20%">
                            <input id="compartida" name="compartida" type="checkbox" onclick="enableArea()"
                                   ...
                                   title="Indicador de operaci&oacute;n compartida entre &aacute;rea" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <input id="franq" style="text-align:right" name="franq" type="text" value="<fmt:formatNumber type="currency" value="${beanOp.amount_franq}" currencySymbol=""/>" size="30" maxlength="30"
                                   alt="decimal-us" title="Monto de franquicia"/>
                        </td>
                        ...
                        <td width="20%">
                          <select id="selcompartida" name="selcompartida" disabled="disabled">
                                <option value="0">--- S e l e c c i o n e ---</option>
                            <c:forEach var="beanArea" items="${listacompartidas}">
                                    <jsp:useBean id="beanArea" scope="page" class="mx.com.bancomer.bbva.orion.ibatis.beans.sophie.Area"/>
                              <option title="${beanArea.name}"
                                            value="<jsp:getProperty name="beanArea" property="idarea"/>"
                                            <%if (beanOp.getIdarea2() != null) {
                if (beanOp.getIdarea2().equals(beanArea.getIdarea())) {%>selected<%}
            }%> >
                                        <jsp:getProperty name="beanArea" property="name"/>
                              </option>
                            </c:forEach>
                          </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                          <select id="selriesgo" name="selriesgo">
                                <option value="0">--- S e l e c c i o n e ---</option>
                ...
                if (beanOp.getIdstatus_risk().equals(beanRiesgo.getIdstatus_risk())) {%>selected<%}
                                        ...
                                        <jsp:getProperty name="beanRiesgo" property="name"/>
                              </option>
                            </c:forEach>
                          </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <select id="selalerta" name="selalerta">
                                <option value="0">--- S e l e c c i o n e ---</option>
                ...
                if (beanOp.getIdalert().equals(beanAlert.getIdalert())) {%>selected<%}
                                        ...
                                        <jsp:getProperty name="beanAlert" property="name"/>
                                    </option>
                                </c:forEach>
                            </select>
                        </td>
                ...
                if (beanOp.getLevel().equals("AREA")) {%>selected<%}
                        ...
                        <td width="20%">
                          <textarea id="soporte" name="soporte" cols="45" rows="5" title="Descripci&oacute;n de soporte requerido"><jsp:getProperty name="beanOp" property="support_required"/></textarea>
                        </td>
                ...
                if (beanOp.getIdproject().equals(beanProject.getIdproject())) {%>selected<%}
                                        ...
                                        <jsp:getProperty name="beanProject" property="name"/>
                                    </option>
                            </c:forEach>
                          </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                          <input id="falta" name="falta" type="text" value="<fmt:formatDate value="${beanOp.date_added}" pattern="dd/MM/yyyy HH:mm" />" size="15" maxlength="15"
                                   title="Fecha de alta de la oportunidad" class="ui-state-default" disabled="disabled"/>
                        </td>
                        ...
                        <td width="20%">
                            <input id="usralta" name="usralta" type="text" value="<jsp:getProperty name="beanOp" property="user_added"/>" size="50" maxlength="50"
                                   title="Nombre del usuario que dio el alta de la oportunidad" class="ui-state-default" disabled="disabled"/>
                        </td>
                    ...
                    <tr id="Act_Buttons">
                        ...
                        <td class="EditButton ui-widget-content" colspan="4" style="text-align:right">
                            <c:if test="${requestScope.write == true}">
                                <a id="btnSave2" class="fm-button ui-state-default ui-corner-all fm-button-icon-left ui-pg-div" href="javascript:void(0)" style="font-size:smaller;">
                                    Guardar
      ...
      <form name="form" action="" enctype="multipart/form-data" method="post">
                                ...
                                <table id="filelist2" class="scroll" cellpadding="0" cellspacing="0">
                                    <tr><td style="border:1px black solid"></td></tr>
                                </table>
                                <div id="pagerfiles2" class="scroll" style="text-align:center;"></div>
      <script type="text/javascript">
                                    $(document).ready(function() {
