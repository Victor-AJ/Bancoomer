...
<script type="text/javascript">
    ...
    jQuery(document).ready(function(){
		...
		loadHtmlAjax(true, $("#divGrafica"), "gra_inv_dir_licencia_g_blo.php?id=1&id_proveedor="+$("#id_proveedor").val()); 
	 	...
	 	$("#sel_grafica").change(function () {
			$("#sel_grafica option:selected").each(function () {	
				...
				//alert ("aaa"+id1);
				$("#divGrafica").html("");	
				loadHtmlAjax(true, $("#divGrafica"), "gra_inv_dir_licencia_g_blo.php?"+id+id1); 
			});
   		});	
