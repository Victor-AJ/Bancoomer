...
<script type="text/javascript">
    ...
    function addButtonEvents(){
			...
			if(fieldsReq()){	
			 	if(editing){
					...
					if (adding) var dispatch ="insert";
				 	...
				 	var url = "process_perfiles.php?dispatch="+dispatch+"&id="+id+"&";
    	...
    	var fAceptar = function()
        {
			...
			var url = "process_perfiles.php?dispatch=delete&id="+gr;
        ...
        $("#btnDelete").click(function()
                ...
                if( gr != null )
                    {
                    jConfirm(true,"\u00bfDesea eliminar el registro "+ gr +" seleccionado", fAceptar, function() { $('#dialogMain').dialog("close"); } );
                }
                else
                    {
            ...
            <script type="text/javascript">
                jQuery(document).ready(function(){
                    var mygrid = jQuery("#list1").jqGrid({
                        caption:"Catálogo de Perfiles",
                        mtype: "GET",                       
						url:'process_perfiles.php?dispatch=load',
						//alert ("Envio"+url);
                        editurl:'process_perfiles.php?dispatch=delete&id',
                        datatype: "json",
                        colNames:['Edo.','Id','Perfil','Indicador','Fecha modifica', 'Usuario modifica','Fecha alta','Usuario alta'],
                        colModel:[   
