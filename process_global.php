...
if(!$sidx) 
	...
	if ($dispatch=="load") 
	{
		...
		//<BITACORA>
			...
			$myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL45_CATALOGO_GLOBAL $tx_catalogo" , "$id_login" ,  "$tx_catalogo", ""  ,  "process_global.php?tx_catalogo=".$tx_catalogo);
			//<\BITACORA>
		...
		{	
			...
			if ($tx_catalogo == "CUENTA_CONTABLE")
			{
				...
				$myBitacora = new Bitacora();
				$myBitacora->anotaBitacora ($mysql, "ALTA" , "TBL45_CATALOGO_GLOBAL $tx_catalogo" , "$id_login" ,  $valBita, ""  ,  "process_global.php?tx_catalogo=".$tx_catalogo);
				//<\BITACORA>
					...
					if ($tx_catalogo == "CUENTA_CONTABLE")
			{
				...
				{	
					...
					if (mysqli_query($mysql, $sql))
					{
						...
						$myBitacora->anotaBitacora ($mysql, "MODIFICACION" , "TBL45_CATALOGO_GLOBAL $tx_catalogo" , "$id_login" ,  $valores, "$id"  ,  "process_global.php?tx_catalogo=".$tx_catalogo);
						//<\BITACORA>
					...
					if (mysqli_query($mysql, $sql)) 
					{
							...
							//<BITACORA>
							$myBitacora = new Bitacora();
							$myBitacora->anotaBitacora ($mysql, "BAJA" , "TBL45_CATALOGO_GLOBAL $tx_catalogo" , "$id_login" ,  "", "$id"  ,  "process_global.php?tx_catalogo=".$tx_catalogo);
							//<\BITACORA>
						...
						{	
							...
							$myBitacora = new Bitacora();
							$whr =str_ireplace("'", " " , $wh); 
							$myBitacora->anotaBitacora ($mysql, "CONSULTA" , "TBL45_CATALOGO_GLOBAL $tx_catalogo" , "$id_login" ,  $whr , ""  ,  "process_global.php?tx_catalogo=".$tx_catalogo);
							//<\BITACORA>
