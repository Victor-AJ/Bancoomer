...
?>
 <input id="par_proveedor" name="par_proveedor" type="hidden" value="<? echo $par_proveedor; ?>" /> 
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function(){
		...
		//var aa= $("#id_proveedor").val()
		//alert ("aaa"+aa);
		
		var id1="&par_proveedor="+$("#par_proveedor").val();
		var id2="&par_anio="+$("#par_anio").val();
		var id3="&par_moneda="+$("#par_moneda").val();		
		var id4="&par_estatus="+$("#par_estatus").val();
		var id5="&par_cuenta="+$("#par_cuenta").val();				
		//alert (id1);
		
		loadHtmlAjax(true, $("#divGrafica"), "gra_fac_dir_monto_g_blo.php?id=1"+id1+id2+id3+id4+id5); 
	 	...
	 	$("#sel_grafica").change(function () {
			$("#sel_grafica option:selected").each(function () {	
				...
				//alert ("aaa"+id1);
				$("#divGrafica").html("");	
				loadHtmlAjax(true, $("#divGrafica"), "gra_fac_dir_monto_g_blo.php?"+id+id1+id2+id3+id4+id5); 
			});
   		});	
    });
</script>
    ...
    <?php
		...
		else if ($par_proveedor==3) $tx_proveedor = "OTROS";
	?>    
